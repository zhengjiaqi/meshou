...
function Item:OnEnter()
	if self.cached then
		...
		local player, bag, slot = self:GetSlotInfo()
		if bag == BANK_CONTAINER or bag == Enum.BagIndex.Reagentbank then
			local getSlot = bag == BANK_CONTAINER and BankButtonIDToInvSlotID or bag == Enum.BagIndex.Reagentbank and ReagentBankButtonIDToInvSlotID
