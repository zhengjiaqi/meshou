...
CombuctorSet:RegisterSubSet(L.Bank, ALL, nil, function(player, bag) return bag ~= Enum.BagIndex.Reagentbank end)
-- CombuctorSet:RegisterSubSet(REAGENT_BANK, ALL, nil, function(player, bag) return bag == Enum.BagIndex.Reagentbank end)
