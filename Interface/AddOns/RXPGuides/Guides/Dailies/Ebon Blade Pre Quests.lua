...
step
	...
	>>一直飞到地面上的男爵西尔弗。跟他谈谈
    .turnin 12887 >>交任务: |cFF00FF25乐趣十足|r
    .turnin 12892 >>交任务: |cFF00FF25乐趣十足|r
    .accept 12891 >>接任务: |cFFFCDC00我有一计……|r
step
...
step
	...
	>>返回银色
    .turnin 12891 >>交任务: |cFF00FF25我有一计……|r
    .accept 12893 >>接任务: |cFFFCDC00解放你的思想|r
step
...
step
	...
	>>返回银色
    .turnin 12893 >>交任务: |cFF00FF25解放你的思想|r
    .accept 12896 >>接任务: |cFFFCDC00顽固的敌人|r
    .accept 12897 >>接任务: |cFFFCDC00顽固的敌人|r
step
...
step << Alliance
    ...
    .turnin 12896 >>交任务: |cFF00FF25顽固的敌人|r
    .accept 12898 >>接任务: |cFFFCDC00暗影拱顶|r
step << Horde
	>>飞回奥格里姆之锤。在船的前室与Koltira Deathweaver交谈
    .turnin 12897 >>交任务: |cFF00FF25顽固的敌人|r
    .accept 12899 >>接任务: |cFFFCDC00暗影拱顶|r
step
    .goto IcecrownGlacier,42.8,24.9
	>>返回男爵西尔弗
	.turnin 12898 >>交任务: |cFF00FF25暗影拱顶|r
    .turnin 12899 >>交任务: |cFF00FF25暗影拱顶|r
    .accept 12938 >>接任务: |cFFFCDC00公爵|r
step
	#completewith next
...
step
	...
	>>进入大楼。与Lankral交谈
    .turnin 12938 >>交任务: |cFF00FF25公爵|r
    .accept 12939 >>接任务: |cFFFCDC00荣耀的挑战|r
step
    .goto Icecrown,43.60,25.13
	>>与Leaper交谈，他绕着帐篷走
    .accept 12955 >>接任务: |cFFFCDC00消灭竞争者|r
step
...
step
	...
	>>返回Leaper
    .turnin 12955 >>交任务: |cFF00FF25消灭竞争者|r
step
    .goto IcecrownGlacier,44.7,20.3
	>>进入大楼。与Lankral交谈
    .turnin 12939 >>交任务: |cFF00FF25荣耀的挑战|r
    .accept 12943 >>接任务: |cFFFCDC00暗影拱顶裁决令|r
step
	#completewith next
...
step
    ...
    .accept 12949 >>接任务: |cFFFCDC00夺取钥匙|r
step
...
step
    .goto IcecrownGlacier,41.0,23.9
	>>回到乌夫兰的大厅。返回Vaelen
    .turnin 12949 >>交任务: |cFF00FF25夺取钥匙|r
    .accept 12951 >>接任务: |cFFFCDC00通知男爵|r
step
    .goto IcecrownGlacier,39.01,23.99,25,0
    .goto IcecrownGlacier,42.9,24.9
	>>离开大厅。返回男爵西尔弗
    .turnin 12951 >>交任务: |cFF00FF25通知男爵|r
    .daily 12995 >>接任务: |cFFFCDC00彰显军威|r
    .accept 13085 >>接任务: |cFFFCDC00维林回来了|r
step
    .goto IcecrownGlacier,43.6,24.1,60,0
    .goto IcecrownGlacier,42.7,26.8
	>>与沿着主要道路巡逻的Vile交谈
    .accept 12992 >>接任务: |cFFFCDC00干掉那些维库人！|r
step
    .goto IcecrownGlacier,43.8,23.3,30,0
    .goto IcecrownGlacier,43.1,21.1
	>>进入大楼。与左侧的Vaelen交谈
    .turnin 13085 >>交任务: |cFF00FF25维林回来了|r
    .accept 12982 >>接任务: |cFFFCDC00黑锋囚犯|r
step
    .goto IcecrownGlacier,44.7,20.4
	>>与Lankral交谈
    .turnin 12943 >>交任务: |cFF00FF25暗影拱顶裁决令|r
    .accept 13084 >>接任务: |cFFFCDC00破坏尤顿海姆|r
step
...
step
    ...
    .turnin 12992 >>交任务: |cFF00FF25干掉那些维库人！|r
    .daily 13071 >>接任务: |cFFFCDC00维尔喜欢火焰！|r
step
    .goto IcecrownGlacier,43.8,23.3,30,0
    .goto IcecrownGlacier,43.1,21.1
	>>进入大楼。与左侧的Vaelen交谈
    .turnin 12982 >>交任务: |cFF00FF25黑锋囚犯|r
step
    .goto IcecrownGlacier,44.7,20.4
	>>与Lankral交谈
    .turnin 13084 >>交任务: |cFF00FF25破坏尤顿海姆|r
step
    .goto IcecrownGlacier,42.9,24.9
    >>返回银色
	.turnin 12995 >>交任务: |cFF00FF25彰显军威|r
	.isQuestComplete 12995
step
    .goto IcecrownGlacier,42.9,24.9
	>>与Silver交谈
    .accept 12806 >>接任务: |cFFFCDC00全速赶往死亡高地！|r
step
    .goto IcecrownGlacier,43.5,25.0
	>>与Leaper交谈，他绕着帐篷走
    .daily 13069 >>接任务: |cFFFCDC00把它们打下来！|r
step
...
step
    ...
    .turnin 12806 >>交任务: |cFF00FF25全速赶往死亡高地！|r
    .accept 12807 >>接任务: |cFFFCDC00迄今为止的故事……|r
step
    .goto IcecrownGlacier,19.5,48.1
	>>再和阿雷特少校谈谈
    .complete 12807,1 --Lord-Commander Arete's tale listened to. (1)
    .turnin 12807 >>交任务: |cFF00FF25迄今为止的故事……|r
    .accept 12810 >>接任务: |cFFFCDC00水中之血|r
	.skipgossip
step
	#sticky
	#label DeathRise
...
step
	>>与Setaal交谈
    .daily 12813 >>接任务: |cFFFCDC00转化尸体|r
    .goto Icecrown,19.67,48.39
	>>与Aurochs交谈。他在中间的火周围巡逻
    .daily 12838 >>接任务: |cFFFCDC00收集情报|r
...
step
	>>回归死亡的崛起。与阿雷特交谈
    .turnin 12810 >>交任务: |cFF00FF25水中之血|r
    .accept 12814 >>接任务: |cFFFCDC00你需要狮鹫|r
    .goto IcecrownGlacier,19.6,48.1
step
	>>与Aurochs交谈。他在中间的火周围巡逻
    .turnin -12838 >>交任务: |cFF00FF25收集情报|r
    .goto IcecrownGlacier,20.1,47.5,20,0
    .goto IcecrownGlacier,20.4,47.9,20,0
    .goto IcecrownGlacier,20.1,48.4,20,0
    .goto IcecrownGlacier,19.7,47.9
	>>与Setaal交谈
    .turnin -12813 >>交任务: |cFF00FF25转化尸体|r
...
step
	...
	>>与Uzo Deathcaller交谈
    .turnin 12814 >>交任务: |cFF00FF25你需要狮鹫|r
    .daily 12815 >>接任务: |cFFFCDC00禁飞区|r
step
...
step
	.goto Icecrown,19.64,47.80
	>>回归死亡的崛起。与Uzo交谈
    .turnin 12815 >>交任务: |cFF00FF25禁飞区|r
step
    >>返回阴影库。与Leaper和Vile交谈
    .turnin -13069 >>交任务: 把它们打下来！
	.goto IcecrownGlacier,43.5,25.0
    .turnin -13071 >>交任务: |cFF00FF25维尔喜欢火焰！|r
    .goto IcecrownGlacier,43.6,24.1,60,0
    .goto IcecrownGlacier,42.7,26.8
step
