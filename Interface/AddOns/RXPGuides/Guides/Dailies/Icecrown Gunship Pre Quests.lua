...
step
	>>返回黑檀守望者
    .turnin 13130 >>交任务: |cFF00FF25公正堡的基石|r
    .turnin 13135 >>交任务: |cFF00FF25危险的能量|r
    .goto IcecrownGlacier,83.0,73.1
    .turnin 13118 >>交任务: |cFF00FF25净化天灾城|r
    .turnin 13122 >>交任务: |cFF00FF25天灾石|r
    .accept 13125 >>接任务: |cFFFCDC00凝固的空气|r
    .goto IcecrownGlacier,83.1,73.0
step
    .goto IcecrownGlacier,82.9,72.8
	>>到小屋里去
    .turnin 13110 >>交任务: |cFF00FF25永不安息的亡者|r
step
...
step
	...
	>>返回黑檀守望者
    .turnin 13125 >>交任务: |cFF00FF25凝固的空气|r
step
    .goto IcecrownGlacier,82.9,72.8
	>>到小屋里去
    .accept 13139 >>接任务: |cFFFCDC00进入诺森德的冰冷腹地|r
step
    .goto IcecrownGlacier,86.0,75.8
	>>返回提里奥
    .turnin 13139 >>交任务: |cFF00FF25进入诺森德的冰冷腹地|r
    .accept 13141 >>接任务: |cFFFCDC00北伐军之峰的战斗|r
step
...
step
    .goto IcecrownGlacier,82.9,72.8
	>>到小屋里去
    .turnin 13141 >>交任务: |cFF00FF25北伐军之峰的战斗|r
    .accept 13157 >>接任务: |cFFFCDC00北伐军之峰|r
step
    .goto IcecrownGlacier,79.8,71.8
	>>回到你防守旗帜的地方。与提里奥交谈
    .turnin 13157 >>交任务: |cFF00FF25北伐军之峰|r
    .accept 13068 >>接任务: |cFFFCDC00勇气的传说|r
step
...
step << Horde
    ...
    .accept 13224 >>接任务: |cFFFCDC00奥格瑞姆之锤|r
step << Alliance
    .goto Icecrown,79.44,72.84
	>>进入塔楼。与床上底层的伊瓦利乌斯交谈
    .accept 13225 >>接任务: |cFFFCDC00破天号|r
step << Alliance
    ...
    .turnin 13225 >>交任务: |cFF00FF25破天号|r
    .accept 13231 >>接任务: |cFFFCDC00破碎前线|r
step << Alliance
	#label slaves1
	#sticky
    .goto IcecrownGlacier,65.1,57.2,0
    ...
    .daily 13300 >>接任务: |cFFFCDC00萨隆邪铁的奴隶|r
step << Alliance
    .goto IcecrownGlacier,65.1,57.2,0
    .goto IcecrownGlacier,64.7,52.4,0
    .goto IcecrownGlacier,62.1,45.9,0
    ...
    .goto IcecrownGlacier,54.7,35.3,0
	>>爬上船尾的楼梯，和骑士队长德罗西通话
    .daily 13336 >>接任务: |cFFFCDC00伊米亚之血|r
    .accept 13341 >>接任务: |cFFFCDC00协助突袭|r
step << Alliance
	#requires slaves1
    .goto IcecrownGlacier,65.1,57.2,0
    .goto IcecrownGlacier,64.7,52.4,0
    ...
    .accept 13296 >>接任务: |cFFFCDC00前往伊米海姆！|r
step << Horde
	.goto IcecrownGlacier,67.00,38.00
	>>飞到奥格瑞姆之锤，一艘在高空盘旋的部落大船。走进前面的大房间。与Sky Reaver Korm Blackscar交谈
    .turnin 13224 >>交任务: |cFF00FF25奥格瑞姆之锤|r
    .accept 13228 >>接任务: |cFFFCDC00破碎前线|r
step << Horde
	>>接受战争使者达沃斯·里奥特和凯尔坦兄弟的任务。他们在楼梯和下层甲板附近走动
    .daily 13302 >>接任务: |cFFFCDC00萨隆邪铁的奴隶|r
    .daily 13330 >>接任务: |cFFFCDC00伊米亚之血|r
    .accept 13340 >>接任务: |cFFFCDC00协助突袭|r
step << Horde
	>>到船的下甲板去。与总工程师Copperclaw交谈
    .accept 13293 >>接任务: |cFFFCDC00前往伊米海姆！|r
step << Alliance
    .goto IcecrownGlacier,62.6,51.3
	>>飞到地面指挥官库普(在地面上)
    .turnin 13341 >>交任务: |cFF00FF25协助突袭|r
    .daily 13309 >>接任务: |cFFFCDC00空中突袭|r
	>>如果你愿意，你可以跳过每日任务
step << Alliance
    #completewith next
...
step << Alliance
	...
	>>返回库普
    .turnin 13309 >>交任务: |cFF00FF25空中突袭|r
...
step << Alliance
    ...
    .daily 13284 >>接任务: |cFFFCDC00地面突袭|r
step << Alliance
...
step << Alliance
	...
	>>飞到地面上的Frazzle
    .turnin 13296 >>交任务: |cFF00FF25前往伊米海姆！|r
step << Alliance
    .goto Icecrown,57.01,62.53
	>>注意：这个任务为你标记PVP。然而，这很容易。
    .daily 13280 >>接任务: |cFFFCDC00占山为王|r
step << Alliance
    #completewith next
...
step << Alliance
	...
	>>单击离开车辆按钮
    .turnin 13280 >>交任务: |cFF00FF25占山为王|r
	.isQuestComplete 13280
step << Horde
	>>飞向地面指挥官Xutjja(他在地面上，而不是在船上)
    .goto IcecrownGlacier,58.3,46.0
    .turnin 13340 >>交任务: |cFF00FF25协助突袭|r
step << Horde
    .goto IcecrownGlacier,58.3,46.0
    .daily 13310 >>接任务: |cFFFCDC00空中突袭|r
	>>如果你愿意，你可以跳过每日任务
step << Horde
	#completewith next
...
step << Horde
    .goto IcecrownGlacier,58.3,46.0
    .turnin 13310 >>交任务: |cFF00FF25空中突袭|r
	.isQuestComplete 13310
step << Horde
    .goto IcecrownGlacier,58.3,46.0
	>>与班组长交谈。如果其他人开始任务并且有大约6分钟的重生时间，他可能不会在这里
    .daily 13301 >>接任务: |cFFFCDC00地面突袭|r
	>>你可以跳过这个任务。这只是一个与其他人紧密联系的日常任务
step << Horde
	#sticky
	#label ymirheimslain
...
step << Horde
    ...
    .turnin 13293 >>交任务: |cFF00FF25前往伊米海姆！|r
    .daily 13283 >>接任务: |cFFFCDC00占山为王|r
step << Horde
    #completewith next
...
step << Horde
    ...
    .accept 13230 >>接任务: |cFFFCDC00为我复仇！|r
step << Horde
...
step << Alliance
    ...
    .turnin 13231 >>交任务: |cFF00FF25破碎前线|r
    .turnin 13232 >>交任务: |cFF00FF25让我解脱吧！|r
    .accept 13286 >>接任务: |cFFFCDC00……所有可能的帮助|r
    .accept 13290 >>接任务: |cFFFCDC00请留意一下……|r
step << Alliance
	#label slaves2
	#sticky
    .goto IcecrownGlacier,65.1,57.2,0
    ...
    .goto IcecrownGlacier,54.7,35.3,0
	>>找到虔诚的押沙兰。他绕着船尾走，上下左右楼梯
    .turnin 13300 >>交任务: |cFF00FF25萨隆邪铁的奴隶|r
...
step << Alliance
    ...
    .goto IcecrownGlacier,54.7,35.3,0
	>>爬上船尾的楼梯，和骑士队长德罗西通话
    .turnin 13336 >>交任务: |cFF00FF25伊米亚之血|r
...
step << Alliance
    ...
    .goto IcecrownGlacier,54.7,35.3,0
	>>与船左后角的Thassarian通话
    .turnin 13286 >>交任务: |cFF00FF25……所有可能的帮助|r
    .accept 13287 >>接任务: |cFFFCDC00知己知彼|r
step << Alliance
    .goto IcecrownGlacier,65.1,57.2,0
    .goto IcecrownGlacier,64.7,52.4,0
    .goto IcecrownGlacier,62.1,45.9,0
    ...
    .goto IcecrownGlacier,54.7,35.3,0
	>>走船中央的楼梯(在马拉德后面)，然后走第一个楼梯两侧的楼梯，进入机舱。与总工程师Boltwrench交谈
    .turnin 13290 >>交任务: |cFF00FF25请留意一下……|r
    .accept 13291 >>接任务: |cFFFCDC00“借来”的技术|r
step << Horde
	.goto IcecrownGlacier,67.00,38.00
	>>飞到奥格里姆之锤，一艘在高空盘旋的部落大船。在前室与Sky Reaver Korm Blackscar交谈
    .turnin 13228 >>交任务: |cFF00FF25破碎前线|r
    .turnin 13230 >>交任务: |cFF00FF25为我复仇！|r
    .accept 13238 >>接任务: |cFFFCDC00有价值的帮手？|r
    .accept 13260 >>接任务: |cFFFCDC00知根知底|r
step << Horde
	>>和你旁边的科尔蒂拉谈谈
    .turnin 13260 >>交任务: |cFF00FF25知根知底|r
    .accept 13237 >>接任务: |cFFFCDC00知己知彼|r
step << Horde
	>>与在楼梯附近走动的克尔坦兄弟交谈
    .turnin 13302 >>交任务: |cFF00FF25萨隆邪铁的奴隶|r
	.isQuestComplete 13302
step
	>>与战争使者达沃斯·里奥特交谈。他也在底层甲板巡逻
    .turnin 13330 >>交任务: |cFF00FF25伊米亚之血|r
	.isQuestComplete 13330
step << Horde
	>>到船的下甲板去。与总工程师Copperclaw交谈
    .turnin 13238 >>交任务: |cFF00FF25有价值的帮手？|r
    .accept 13239 >>接任务: |cFFFCDC00爆炸油|r
step << Alliance
	>>返回地面指挥官库普
    .goto Icecrown,62.60,51.35
    .turnin 13284 >>交任务: |cFF00FF25地面突袭|r
	.isQuestComplete 13284
step << Horde
	>>返回地面指挥官Xutjja
    .goto IcecrownGlacier,58.3,46.2
    .turnin 13301 >>交任务: |cFF00FF25地面突袭|r
...
step << Alliance
    ...
    .turnin 13287 >>交任务: |cFF00FF25知己知彼|r
    .accept 13288 >>接任务: |cFFFCDC00你的憎恶伙伴|r
    .accept 13294 >>接任务: |cFFFCDC00对抗巨人|r
step << Alliance
	#requires notdead
    .goto IcecrownGlacier,65.1,57.2,0
    .goto IcecrownGlacier,64.7,52.4,0
    ...
    .goto IcecrownGlacier,54.7,35.3
	>>走船中央的楼梯(在马拉德后面)，然后走第一个楼梯两侧的楼梯，进入机舱。与总工程师Boltwrench交谈
    .turnin 13291 >>交任务: |cFF00FF25“借来”的技术|r
step << Horde
	.goto IcecrownGlacier,67.00,38.00
	>>飞到奥格瑞姆之锤，一艘在高空盘旋的部落大船。在船的前室和科尔蒂拉通话
    .turnin 13237 >>交任务: |cFF00FF25知己知彼|r
    .accept 13264 >>接任务: |cFFFCDC00你的憎恶伙伴|r
	.accept 13277 >>接任务: |cFFFCDC00对抗巨人|r
step << Horde
	>>到船的下甲板去。与总工程师Copperclaw交谈
    .turnin 13239 >>交任务: |cFF00FF25爆炸油|r
step
...
step << Horde
	.goto IcecrownGlacier,67.00,38.00
	>>返回奥格里姆之锤。与科尔蒂拉交谈
    .turnin 13264 >>交任务: |cFF00FF25你的憎恶伙伴|r
    .accept 13351 >>接任务: |cFFFCDC00预览|r
step << Alliance
    .goto IcecrownGlacier,65.1,57.2,0
    .goto IcecrownGlacier,64.7,52.4,0
    .goto IcecrownGlacier,62.1,45.9,0
    ...
    .goto IcecrownGlacier,54.7,35.3
	>>返回破天者。与Thassarian交谈
    .turnin 13288 >>交任务: |cFF00FF25你的憎恶伙伴|r
    .accept 13315 >>接任务: |cFFFCDC00预览|r
step << Alliance
	>>在大墙上方平台上的航路点上方飞行
...
step << Horde
	.goto IcecrownGlacier,67.00,38.00
	>>飞到奥格瑞姆之锤，一艘在高空盘旋的部落大船。在船的前室和科尔蒂拉通话
    .turnin 13351 >>交任务: |cFF00FF25预览|r
	.turnin 13277 >>交任务: |cFF00FF25对抗巨人|r
    .accept 13355 >>接任务: |cFFFCDC00无法复制|r
    .accept 13354 >>接任务: |cFFFCDC00指挥体系|r
    .accept 13352 >>接任务: |cFFFCDC00从天而“降”|r
	.accept 13279 >>接任务: |cFFFCDC00化学常识|r
    .accept 13278 >>接任务: |cFFFCDC00污染者科普洛斯|r
step << Horde
	>>到船的下甲板去。与总工程师Copperclaw交谈
    .accept 13379 >>接任务: |cFFFCDC00绿色科技|r
step << Alliance
    .goto IcecrownGlacier,65.1,57.2,0
    .goto IcecrownGlacier,64.7,52.4,0
    .goto IcecrownGlacier,62.1,45.9,0
    ...
    .goto IcecrownGlacier,54.7,35.3
	>>飞到“破天者”号上，这是一艘在高空飞行的大型联盟飞船。与船左后角的Thassarian通话
    .turnin 13315 >>交任务: |cFF00FF25预览|r
    .turnin 13294 >>交任务: |cFF00FF25对抗巨人|r
    .accept 13318 >>接任务: |cFFFCDC00从天而“降”|r
    .accept 13319 >>接任务: |cFFFCDC00指挥体系|r
    .accept 13320 >>接任务: |cFFFCDC00无法复制|r
    .accept 13295 >>接任务: |cFFFCDC00化学常识|r
    .accept 13298 >>接任务: |cFFFCDC00污染者科普洛斯|r
step << Alliance
	>>走船中央的楼梯(在马拉德后面)，然后走第一个楼梯两侧的楼梯，进入机舱。与总工程师Boltwrench交谈
    .accept 13383 >>接任务: |cFFFCDC00“借来”的技术|r
step
	#completewith next
...
step << Alliance
	...
	.turnin 13383 >>交任务: |cFF00FF25吉普利·基罗赫斯|r
	.accept 13380 >>接任务: |cFFFCDC00委以重任|r
step << Alliance
...
step << Alliance
	>>与Killohertz交谈
    .goto IcecrownGlacier,53.96,42.93
    .turnin 13380 >>交任务: |cFF00FF25委以重任|r
step << Horde
	>>飞向空中的小平台。与Tezzla交谈
    .goto IcecrownGlacier,53.99,36.87
    .turnin 13379 >>交任务: |cFF00FF25绿色科技|r
    .accept 13373 >>接任务: |cFFFCDC00边缘科学的益处|r
step << Horde
...
step << Horde
    ...
    .turnin 13373 >>交任务: |cFF00FF25边缘科学的益处|r
step << Alliance
    .goto IcecrownGlacier,65.1,57.2,0
    .goto IcecrownGlacier,64.7,52.4,0
    .goto IcecrownGlacier,62.1,45.9,0
    ...
    .goto IcecrownGlacier,54.7,35.3
	>>飞到“破天者”号上，这是一艘在高空飞行的大型联盟飞船。与船左后角的Thassarian通话
    .turnin 13318 >>交任务: |cFF00FF25从天而“降”|r
    .turnin 13319 >>交任务: |cFF00FF25指挥体系|r
    .turnin 13295 >>交任务: |cFF00FF25化学常识|r
    .turnin 13298 >>交任务: |cFF00FF25污染者科普洛斯|r
    .accept 13342 >>接任务: |cFFFCDC00活动窃听器|r
    .accept 13345 >>接任务: |cFFFCDC00需要更多情报|r
step << Alliance
    .goto IcecrownGlacier,65.1,57.2,0
    .goto IcecrownGlacier,64.7,52.4,0
    .goto IcecrownGlacier,62.1,45.9,0
    ...
    .goto IcecrownGlacier,54.7,35.3
	>>走船中央的楼梯(在马拉德后面)，然后走第一个楼梯两侧的楼梯，进入机舱。与总工程师Boltwrench交谈
    .turnin 13320 >>交任务: |cFF00FF25无法复制|r
    .accept 13321 >>接任务: |cFFFCDC00重新考验|r
step << Horde
	.goto IcecrownGlacier,67.00,38.00
	>>飞到奥格瑞姆之锤，一艘在高空盘旋的部落大船。走进前面的大房间。与Kolitra交谈
	.turnin 13352 >>交任务: |cFF00FF25从天而“降”|r
    .turnin 13354 >>交任务: |cFF00FF25指挥体系|r
    .turnin 13279 >>交任务: |cFF00FF25化学常识|r
    .turnin 13278 >>交任务: |cFF00FF25污染者科普洛斯|r
    .accept 13358 >>接任务: |cFFFCDC00活动窃听器|r
    .accept 13366 >>接任务: |cFFFCDC00需要更多情报|r
step << Horde
	>>到船的下甲板去。与总工程师Copperclaw交谈
    .turnin 13355 >>交任务: |cFF00FF25无法复制|r
    .accept 13356 >>接任务: |cFFFCDC00重新考验|r
step
...
step << Alliance
    ...
    .goto IcecrownGlacier,54.7,35.3
	>>飞到“破天者”号上，这是一艘在高空飞行的大型联盟飞船。与船左后角的Thassarian通话
    .turnin 13342 >>交任务: |cFF00FF25活动窃听器|r
    .turnin 13345 >>交任务: |cFF00FF25需要更多情报|r
    .accept 13346 >>接任务: |cFFFCDC00片刻不得安宁|r
    .accept 13332 >>接任务: |cFFFCDC00构建路障|r
step << Alliance
    .goto IcecrownGlacier,65.1,57.2,0
    .goto IcecrownGlacier,64.7,52.4,0
    .goto IcecrownGlacier,62.1,45.9,0
    ...
    .goto IcecrownGlacier,54.7,35.3
	>>走船中央的楼梯(在马拉德后面)，然后走第一个楼梯两侧的楼梯，进入机舱。与总工程师Boltwrench交谈
    .turnin 13321 >>交任务: |cFF00FF25重新考验|r
step << Horde
	.goto IcecrownGlacier,67.00,38.00
	>>飞到奥格瑞姆之锤，一艘在高空盘旋的部落大船。走进前面的大房间。与Kolitra交谈
    .turnin 13358 >>交任务: |cFF00FF25活动窃听器|r
	.turnin 13366 >>交任务: |cFF00FF25需要更多情报|r
    .accept 13367 >>接任务: |cFFFCDC00片刻不得安宁|r
    .accept 13306 >>接任务: |cFFFCDC00构建路障|r
step << Horde
	>>到船的下甲板去。与总工程师Copperclaw交谈
    .turnin 13356 >>交任务: |cFF00FF25重新考验|r
step
...
step << Alliance
    ...
    .goto IcecrownGlacier,54.7,35.3
	>>飞到“破天者”号上，这是一艘在高空飞行的大型联盟飞船。与船左后角的Thassarian通话
    .turnin 13346 >>交任务: |cFF00FF25片刻不得安宁|r
    .turnin 13332 >>交任务: |cFF00FF25构建路障|r
	.accept 13337 >>接任务: |cFFFCDC00铁墙壁垒|r
	.accept 13334 >>接任务: |cFFFCDC00溅血的旗帜|r
step << Horde
	.goto IcecrownGlacier,67.00,38.00
	>>飞到奥格瑞姆之锤，一艘在高空盘旋的部落大船。走进前面的大房间。与Kolitra交谈
    .turnin 13367 >>交任务: |cFF00FF25片刻不得安宁|r
    .turnin 13306 >>交任务: |cFF00FF25构建路障|r
	.accept 13312 >>接任务: |cFFFCDC00铁墙壁垒|r
	.accept 13307 >>接任务: |cFFFCDC00溅血的旗帜|r
step
...
step << Alliance
    ...
    .goto IcecrownGlacier,54.7,35.3
	>>飞到“破天者”号上，这是一艘在高空飞行的大型联盟飞船。与船左后角的Thassarian通话
	.turnin 13334 >>交任务: |cFF00FF25溅血的旗帜|r
	.turnin 13337 >>交任务: |cFF00FF25铁墙壁垒|r
	>>走进《破天荒》中马拉德面对的大房间，和贾斯汀谈谈
	.accept 13314 >>接任务: |cFFFCDC00获取情报|r
step << Alliance
...
step << Alliance
    ...
    .goto IcecrownGlacier,54.7,35.3
	>>走进《破天荒》中马拉德面对的大房间，和贾斯汀谈谈
	.turnin 13314 >>交任务: |cFF00FF25获取情报|r
step << Horde
	.goto IcecrownGlacier,67.00,38.00
	>>飞到奥格瑞姆之锤，一艘在高空盘旋的部落大船。走进前面的大房间。与Kolitra交谈
	.turnin 13312 >>交任务: |cFF00FF25铁墙壁垒|r
	.turnin 13307 >>交任务: |cFF00FF25溅血的旗帜|r
step << Horde
	>>与你旁边的Krom Blackscar交谈
	.accept 13313 >>接任务: |cFFFCDC00遮挡天空|r
step << Horde
...
step << Horde
	...
	.turnin 13313 >>交任务: |cFF00FF25遮挡天空|r
step
