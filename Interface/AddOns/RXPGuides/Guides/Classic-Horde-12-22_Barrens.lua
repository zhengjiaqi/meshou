...
step << Warrior
    ...
    .turnin 1502 >>交任务: |cFF00FF25索恩格瑞姆·火眼|r
    .accept 1503 >>接任务: |cFFFCDC00锻造好的钢锭|r
step << Warrior
    >>掠夺灰色箱子以获得锻钢棒
...
step << Warrior
    .goto The Barrens,57.2,30.3
    .turnin 1503 >>交任务: |cFF00FF25锻造好的钢锭|r
step << Shaman
    #sticky
    >>杀死并掠夺剃须刀以获取火油
...
step << !Shaman
	...
	.turnin 1358 >>交任务: |cFF00FF25给赫布瑞姆的样本|r
step << !Shaman
	#som
	#phase 3-6
    .goto The Barrens,51.5,30.1
...
step << Shaman
    ...
    .turnin 1525 >>交任务: |cFF00FF25火焰的召唤|r
    .accept 1526 >>接任务: |cFFFCDC00火焰的召唤|r
step << Shaman
    >>跑到山顶。单击钎焊器
...
step << Shaman
    ...
    .turnin 1526 >>交任务: |cFF00FF25火焰的召唤|r
    .accept 1527 >>接任务: |cFFFCDC00火焰的召唤|r
step << Shaman
    #sticky
    #completewith next
    >>杀死你看到的任何哲夫拉。抢走他们的马蹄
...
step << Shaman
    ...
    .turnin 1527 >>交任务: |cFF00FF25火焰的召唤|r
step << Shaman
     >>在这里掠夺酒桶。如果还没有结束，等待重生
    .goto The Barrens,55.8,20.0
    .collect 4926,1,819 --Collect Chen's Empty Keg
...
step << !Undead !Rogue
   ...
   .turnin 850 >>交任务: |cFF00FF25科卡尔首领|r
    .accept 851 >>接任务: |cFFFCDC00狂热的维罗戈|r
step << !Undead !Rogue
	#era
	.isQuestComplete 855
    .goto The Barrens,45.39,28.44
...
step << Rogue
    ...
    .trainer >>训练你的职业技能
	>>确保你已经训练过拾取锁定
    .accept 2379 >>接任务: |cFFFCDC00赞杜沙|r
	.turnin 1963 >>交任务: |cFF00FF25碎手氏族|r
--	.accept 1858 >>接任务: |cFFFCDC00碎手氏族|r
--N ..Make sure you train Pick Pocket
step << Rogue
    .goto Orgrimmar,42.72,52.95
    .turnin 2379 >>交任务: |cFF00FF25赞杜沙|r
    .accept 2382 >>接任务: |cFFFCDC00棘齿城的维尼克斯|r
step << skip
    >>客栈里的扒手游戏。打开你包里的泰山背包
...
step << skip
    .goto Orgrimmar,43.05,53.73
	.turnin 1858 >>交任务: |cFF00FF25碎手氏族|r
--N Rogue class q
step << Warlock
...
step << Druid
    .zone Moonglade >>前往: |cFFDB2EEF月光林地|r
step << Druid
    >>楼上的
...
step << Rogue
    ...
    .turnin 2382 >>交任务: |cFF00FF25棘齿城的维尼克斯|r
    .accept 2381 >>接任务: |cFFFCDC00抢劫海盗|r
step << Rogue
...
step << Hunter
    .goto The Barrens,63.0,37.2
    .accept 3921 >>接任务: |cFFFCDC00维妮·布特巴克|r
step
    .isQuestComplete 896
...
step << Rogue
   >>跑回棘轮
    .goto The Barrens,63.07,36.31
    .turnin 2381 >>交任务: |cFF00FF25抢劫海盗|r
step
.goto The Barrens,62.7,36.3
    >>跑回棘轮 << !Rogue
...
step
    ...
    .accept 6382 >>接任务: |cFFFCDC00灰谷狩猎|r
step
    #sticky
    #label Owatanka2
    #completewith next
...
step << Shaman
	...
	.accept 1528 >>接任务: |cFFFCDC00水之召唤|r
step << Warlock
	#som
...
step
    ...
    .accept 1058 >>接任务: |cFFFCDC00金吉尔的森林魔法|r
	#era
step
...
step << Priest
	...
	.accept 5644 >>接任务: |cFFFCDC00噬灵瘟疫|r
step << Shaman
    .goto Thunder Bluff,25.1,20.6
	.accept 1529 >>接任务: |cFFFCDC00水之召唤|r
step
...
#era/som
    ...
    .accept 1060 >>接任务: |cFFFCDC00写给金吉尔的信|r
step
    .goto The Barrens,51.10,29.60
    .accept 868 >>接任务: |cFFFCDC00蝎卵|r
step
    .goto The Barrens,51.50,30.87
    .accept 6541 >>接任务: |cFFFCDC00向卡德拉克报到|r
step << Hunter
    .goto The Barrens,49.00,11.20
    .turnin 3921 >>交任务: |cFF00FF25维妮·布特巴克|r
step
	>>去塔的二楼
    .goto The Barrens,48.12,5.42
    .turnin 6541 >>交任务: |cFF00FF25向卡德拉克报到|r
--    .accept 6543 >>接任务: |cFFFCDC00战歌报告|r
step << Hunter
...
step << Shaman
    ...
    .turnin 1528 >>交任务: |cFF00FF25水之召唤|r
step << Shaman
	#completewith next
    .goto The Barrens,65.8,43.8
    .turnin 1529 >>交任务: |cFF00FF25水之召唤|r
step << Shaman
	#label call
    .goto The Barrens,65.8,43.8
    .accept 1530 >>接任务: |cFFFCDC00水之召唤|r
...
step << Shaman
    ...
    .turnin 1530 >>交任务: |cFF00FF25水之召唤|r
    .accept 1535 >>接任务: |cFFFCDC00水之召唤|r
step << Shaman
