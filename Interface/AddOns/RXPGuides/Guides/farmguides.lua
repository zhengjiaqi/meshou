...
step
    ...
    .zone Netherstorm >>前往: |cFFDB2EEF虚空风暴|r
step
    #hidewindow
    +测验
...
step
    ...
    .zone Borean Tundra >>前往: |cFFDB2EEF北风苔原|r
step
    #hidewindow
    +测验
...
step
    #sticky
    .waypoint Sholazar Basin,50,50
    .zone Sholazar Basin >>前往: |cFFDB2EEF北风苔原|r
step
    #hidewindow
    +测验
...
step
    ...
    .zone Howling Fjord >>前往: |cFFDB2EEF嚎风峡湾|r
step
    #hidewindow
    +测验
...
step
    ...
    .zone The Storm Peaks >>前往: |cFFDB2EEF风暴峭壁|r
step
    #hidewindow
    +测验
...
step
    ...
    .zone Wintergrasp >>前往: |cFFDB2EEF冬拥湖|r
step
    #hidewindow
    +测验
