...
step
    ...
    .accept 9279 >>接任务: |cFFFCDC00你活下来了！|r
step << Shaman
	#completewith next
...
step
    ...
    .turnin 9279 >>交任务: |cFF00FF25你活下来了！|r
    .accept 9280 >>接任务: |cFFFCDC00补充治疗水晶|r
step
    .goto Azuremyst Isle,79.1,46.5
    .accept 10302 >>接任务: |cFFFCDC00暴躁的变异体|r
step
	#sticky
    #label mothblood
    >>杀死并掠夺谷蛾
...
step
    ...
    .turnin 10302 >>交任务: |cFF00FF25暴躁的变异体|r
    .accept 9293 >>接任务: |cFFFCDC00必需的措施......|r
    .accept 9799 >>接任务: |cFFFCDC00跑腿采花|r
step
...
step
    #requires mothblood
    .goto Azuremyst Isle,79.1,46.5
    .turnin 9293 >>交任务: |cFF00FF25必需的措施......|r
    .accept 9294 >>接任务: |cFFFCDC00净化湖水|r
    .turnin 9799 >>交任务: |cFF00FF25跑腿采花|r
step
    .goto Azuremyst Isle,80.4,45.8
    .turnin 9280 >>交任务: |cFF00FF25补充治疗水晶|r
    .accept 9409 >>接任务: |cFFFCDC00紧急物资！|r
step
	#completewith next
	    .goto Azuremyst Isle,80.0,47.1
	.vendor >>供应商和维修
step << Mage
	...
	.turnin 9290 >>交任务: |cFF00FF25法师训练|r
	.trainer >>训练你的法术
step << Paladin
	#completewith next
	.turnin 9287 >>交任务: |cFF00FF25圣骑士训练|r
	    .goto Azuremyst Isle,79.7,48.2
	.trainer >>训练你的法术
step
    .goto Azuremyst Isle,79.9,49.2
    .turnin 9409 >>交任务: |cFF00FF25紧急物资！|r
    .accept 9283 >>接任务: |cFFFCDC00拯救幸存者！|r
step << Shaman
    .goto Azuremyst Isle,79.3,49.1
    .accept 9449 >>接任务: |cFFFCDC00大地的召唤|r
	.turnin 9421 >>交任务: |cFF00FF25萨满祭司训练|r
	.trainer >>列车接地冲击
step << Shaman
    .goto Azuremyst Isle,71.3,39.1
    .turnin 9449 >>交任务: |cFF00FF25大地的召唤|r
    .accept 9450 >>接任务: |cFFFCDC00大地的召唤|r
step << Warrior
    .goto Azuremyst Isle,79.6,49.4
	.turnin 9289 >>交任务: |cFF00FF25战士训练|r
	.trainer >>训练你的法术
step
    #sticky
    #label survivors
...
step << Shaman
    .goto Azuremyst Isle,71.3,39.1
    .accept 9451 >>接任务: |cFFFCDC00大地的召唤|r
    .turnin 9450 >>交任务: |cFF00FF25大地的召唤|r
step << Shaman
    .goto Azuremyst Isle,79.3,49.1
    .turnin 9451 >>交任务: |cFF00FF25大地的召唤|r
step << Hunter
	.goto Azuremyst Isle,79.86,49.67
	.accept 9288 >>接任务: |cFFFCDC00猎人训练|r
	.turnin 9288 >>交任务: |cFF00FF25猎人训练|r
	.train 1978 >>火车蛇刺
step << Priest
	.goto Azuremyst Isle,79.3,50.9
    .vendor >>从Ryosh购买更多水
...
step
    ...
    .accept 9305 >>接任务: |cFFFCDC00备用零件|r
step
    .goto Azuremyst Isle,79.5,51.7
    .accept 9303 >>接任务: |cFFFCDC00疫苗|r
step
...
step
    .goto Azuremyst Isle,79.4,51.3
    .turnin 9305 >>交任务: |cFF00FF25备用零件|r
step
    .goto Azuremyst Isle,79.5,51.5
    .turnin 9303 >>交任务: |cFF00FF25疫苗|r
    .accept 9309 >>接任务: |cFFFCDC00失踪的斥候|r
step
	#completewith next
	.goto Azuremyst Isle,79.3,50.9
	.vendor >>供应商和维修
...
step
    ...
    .turnin 9294 >>交任务: |cFF00FF25净化湖水|r
step
    #label survivors2
    #requires survivors
    .goto Azuremyst Isle,80.1,49.0
    .turnin 9283 >>交任务: |cFF00FF25拯救幸存者！|r
step
    .goto Azuremyst Isle,79.5,51.6
    .turnin 9311 >>交任务: |cFF00FF25血精灵间谍|r
    .turnin 9798 >>交任务: |cFF00FF25血精灵计划书|r
    .accept 9312 >>接任务: |cFFFCDC00图像发射器|r
step
    .goto Azuremyst Isle,79.4,51.2
    .turnin 9312 >>交任务: |cFF00FF25图像发射器|r
    .accept 9313 >>接任务: |cFFFCDC00前往碧蓝岗哨|r
step
    #requires survivors2
    .goto Azuremyst Isle,64.6,54.2
    .accept 9314 >>接任务: |cFFFCDC00碧蓝岗哨的消息|r
step
    .goto Azuremyst Isle,61.1,54.2
    .accept 9452 >>接任务: |cFFFCDC00美味的红钳鱼|r
step
	#completewith end
	>>留心Draenei Younglings。这是一次罕见的邂逅。若你们找到了，当他们和暴徒战斗时，用纳鲁的礼物(你们的种族)对付他们。然后，接受任务
	.accept 9612 >>接任务: |cFFFCDC00非常感谢！|r
...
step
	...
	.collect 23678,1
    .accept 9455 >>接任务: |cFFFCDC00奇怪的发现|r
step
	#sticky
	#completewith next
...
step
    ...
    .accept 9463 >>接任务: |cFFFCDC00医疗材料|r
step << Shaman
    #sticky
...
step
	.isOnQuest 9612
	.turnin 9612 >>交任务: |cFF00FF25非常感谢！|r
    .turnin 9455 >>交任务: |cFF00FF25奇怪的发现|r
    .accept 9456 >>接任务: |cFFFCDC00清理夜行豹......|r
...
step
    ...
    .turnin 9313 >>交任务: |cFF00FF25前往碧蓝岗哨|r
step
    .goto Azuremyst Isle,48.4,49.3
    .turnin 9314 >>交任务: |cFF00FF25碧蓝岗哨的消息|r
step
	.goto Azuremyst Isle,48.4,49.3
...
step << Priest
    .goto Azuremyst Isle,48.6,49.3
	 .trainer >>训练你的法术
    .accept 9586 >>接任务: |cFFFCDC00帮助塔瓦拉|r
step << Mage
...
step
    ...
    .accept 9506 >>接任务: |cFFFCDC00第三类接触|r
step
    .goto Azuremyst Isle,46.7,70.6
    .accept 9512 >>接任务: |cFFFCDC00曲奇的大餐|r
step
...
step
    ...
    .turnin 9512 >>交任务: |cFF00FF25曲奇的大餐|r
step
    .goto Azuremyst Isle,47.0,70.3
    .turnin 9506 >>交任务: |cFF00FF25第三类接触|r
    .accept 9530 >>接任务: |cFFFCDC00天才的方案！|r
    .accept 9513 >>接任务: |cFFFCDC00夺回废墟|r
step
    .goto Azuremyst Isle,47.2,70.1
    .accept 9523 >>接任务: |cFFFCDC00贵重物品，小心轻放|r
step
    #sticky
...
step
	...
	>>途中研磨
    .turnin 9530 >>交任务: |cFF00FF25天才的方案！|r
    .accept 9531 >>接任务: |cFFFCDC00间谍之树|r
step
...
step
	.goto Azuremyst Isle,49.8,51.9
	.accept 9454 >>接任务: |cFFFCDC00狩猎月痕鹿|r
    .turnin 9454 >>交任务: |cFF00FF25狩猎月痕鹿|r
    .accept 10324 >>接任务: |cFFFCDC00狩猎月痕鹿|r
step
    .goto Azuremyst Isle,48.4,51.8
    .turnin 9463 >>交任务: |cFF00FF25医疗材料|r
    .accept 9473 >>接任务: |cFFFCDC00备选方案的备选方案|r
step
    .goto Azuremyst Isle,48.9,51.1
    .accept 10428 >>接任务: |cFFFCDC00失踪的渔夫|r
step
    .goto Azuremyst Isle,49.4,51.1
    .accept 9538 >>接任务: |cFFFCDC00学外语......|r
step
	.goto Azuremyst Isle,49.4,51.1
...
step
    .goto Azuremyst Isle,49.4,51.1
    .turnin 9538 >>交任务: |cFF00FF25学外语......|r
    .accept 9539 >>接任务: |cFFFCDC00库欧图腾|r
step << Shaman
...
step << Priest
    ...
    .turnin 9586 >>交任务: |cFF00FF25帮助塔瓦拉|r
	 .trainer >>训练你的法术
step << Paladin
    .goto Azuremyst Isle,48.4,49.5
    .trainer >>训练你的法术
...
step
    ...
    .turnin 9539 >>交任务: |cFF00FF25库欧图腾|r
    .accept 9540 >>接任务: |cFFFCDC00提克提图腾|r
step
	>>跳下悬崖或等待灵魂给你减速
...
step
    ...
    .turnin 9540 >>交任务: |cFF00FF25提克提图腾|r
    .accept 9541 >>接任务: |cFFFCDC00尤尔图腾|r
...
step
    ...
    .turnin 9452 >>交任务: |cFF00FF25美味的红钳鱼|r
    .accept 9453 >>接任务: |cFFFCDC00找到艾克提恩！|r
step
    .goto Azuremyst Isle,63.2,68.0
    >>点击水下图腾
    .turnin 9541 >>交任务: |cFF00FF25尤尔图腾|r
    .accept 9542 >>接任务: |cFFFCDC00瓦克图腾|r
...
step
    ...
    .turnin 9542 >>交任务: |cFF00FF25瓦克图腾|r
    .accept 9544 >>接任务: |cFFFCDC00阿基达的预言|r
step
	#label azuremyst2
...
step
    ...
    .turnin 10428 >>交任务: |cFF00FF25失踪的渔夫|r
    .accept 9527 >>接任务: |cFFFCDC00遗体|r
step
...
step
    .goto Azuremyst Isle,47.0,70.3
    .turnin 9513 >>交任务: |cFF00FF25夺回废墟|r
    .turnin 9523 >>交任务: |cFF00FF25贵重物品，小心轻放|r
    .turnin 9531 >>交任务: |cFF00FF25间谍之树|r
    .accept 9537 >>接任务: |cFFFCDC00绳侏儒以法|r
    >>暂时不要交上符文覆盖的平板电脑，否则将开始一个长的RP序列
step
    .goto Azuremyst Isle,47.0,70.3
    .turnin 9514 >>交任务: |cFF00FF25写满符文的石板|r
step << Hunter
	#sticky
    .goto Azuremyst Isle,48.8,72.7
	>>沿着海岸杀死螃蟹
...
step
    ...
    .turnin 9537 >>交任务: |cFF00FF25绳侏儒以法|r
    .accept 9602 >>接任务: |cFFFCDC00邪恶的书信|r
step
    .goto Azuremyst Isle,47.1,70.3
    .accept 9515 >>接任务: |cFFFCDC00督军斯雷提兹|r
    .maxlevel 9
step << !Hunter
    #completewith next
...
step
    .goto Azuremyst Isle,49.9,51.9
    .turnin 9453 >>交任务: |cFF00FF25找到艾克提恩！|r
    .turnin 10324 >>交任务: |cFF00FF25狩猎月痕鹿|r
step
    .goto Azuremyst Isle,49.5,51.2
    .turnin 9544 >>交任务: |cFF00FF25阿基达的预言|r
    .accept 9559 >>接任务: |cFFFCDC00止松要塞|r
step
    .goto Azuremyst Isle,48.5,51.5
    .turnin 9473 >>交任务: |cFF00FF25备选方案的备选方案|r
step
    .goto Azuremyst Isle,47.2,50.7
    .turnin 9456 >>交任务: |cFF00FF25清理夜行豹......|r
    .turnin 9602 >>交任务: |cFF00FF25邪恶的书信|r
    .accept 9623 >>接任务: |cFFFCDC00成年|r
step
    .goto Azuremyst Isle,47.2,50.7
    .isOnQuest 9612
    .goto Azuremyst Isle,47.2,50.7
...
step << Warrior
    .goto Azuremyst Isle,50.0,50.5
    .trainer >>训练你的10级法术
    .accept 9582 >>接任务: |cFFFCDC00一人之力|r
step << Shaman
    .goto Azuremyst Isle,48.05,50.41
    .accept 9464 >>接任务: |cFFFCDC00火焰的召唤|r
step << Hunter
    .goto Azuremyst Isle,49.7,51.9
    .accept 9757 >>接任务: |cFFFCDC00寻找女猎手凯拉·夜弓|r
step << Hunter
    .goto Azuremyst Isle,24.2,54.3
    .turnin 9757 >>交任务: |cFF00FF25寻找女猎手凯拉·夜弓|r
    .accept 9591 >>接任务: |cFFFCDC00驯服野兽|r
step << Hunter
...
step << Hunter
    .goto Azuremyst Isle,24.2,54.3
    .turnin 9591 >>交任务: |cFF00FF25驯服野兽|r
    .accept 9592 >>接任务: |cFFFCDC00驯服野兽|r
step << Hunter
    .goto The Exodar,81.5,51.6
    .turnin 9623 >>交任务: |cFF00FF25成年|r
    .accept 9625 >>接任务: |cFFFCDC00雷象可不是好玩的！|r
    --?
step << Hunter
...
step << Hunter
    .goto Azuremyst Isle,24.2,54.3
    .turnin 9592 >>交任务: |cFF00FF25驯服野兽|r
    .accept 9593 >>接任务: |cFFFCDC00驯服野兽|r
step << Hunter
...
step << Hunter
    .goto Azuremyst Isle,24.2,54.3
    .turnin 9593 >>交任务: |cFF00FF25驯服野兽|r
    .accept 9675 >>接任务: |cFFFCDC00野兽训练|r
step << Hunter
    #completewith next
...
step << Hunter
    ...
    .turnin 9675 >>交任务: |cFF00FF25野兽训练|r
...
step
    #label murloc1
    .goto Azuremyst Isle,44.7,23.5
    .accept 9562 >>接任务: |cFFFCDC00鱼人......|r
step
    .goto Azuremyst Isle,44.8,23.8
    .accept 9560 >>接任务: |cFFFCDC00末日的野兽！|r
step
    .goto Azuremyst Isle,46.6,20.7
    .turnin 9559 >>交任务: |cFF00FF25止松要塞|r
step << Shaman
    #sticky
	#completewith next
	>>杀死掠夺者
...
step << Shaman
    ...
    .turnin 9464 >>交任务: |cFF00FF25火焰的召唤|r
    .accept 9465 >>接任务: |cFFFCDC00火焰的召唤|r
step << Hunter tbc
	#sticky
	#label pet1
...
step
    ...
    .goto Azuremyst Isle,44.8,23.8
    .turnin 9560 >>交任务: |cFF00FF25末日的野兽！|r
step
    .goto Azuremyst Isle,46.8,21.2
    .accept 9573 >>接任务: |cFFFCDC00欧莫鲁酋长|r
step
    .goto Azuremyst Isle,46.6,20.6
    .accept 9565 >>接任务: |cFFFCDC00搜索止松要塞|r
step
    >>向洞穴的尽头开始清理。保持在上层。
...
step
    ...
    >>下来，朝洞穴后面走去。
    .turnin 9565 >>交任务: |cFF00FF25搜索止松要塞|r
    .accept 9566 >>接任务: |cFFFCDC00血水晶|r
    >>当你靠近红色水晶时，你可能会在附近发现一只名叫“库尔肯”的双头狗。别杀了它，这群暴徒是下一个任务的一部分
step
    .goto Azuremyst Isle,46.7,20.8
    .turnin 9566 >>交任务: |cFF00FF25血水晶|r
step
    .goto Azuremyst Isle,47.0,22.2
    .accept 9570 >>接任务: |cFFFCDC00可怕的库肯|r
step
	#completewith next
...
step
    .goto Azuremyst Isle,46.8,21.2
    .turnin 9573 >>交任务: |cFF00FF25欧莫鲁酋长|r
step
...
step
    .goto Azuremyst Isle,47.0,22.2
    .turnin 9570 >>交任务: |cFF00FF25可怕的库肯|r
    .accept 9571 >>接任务: |cFFFCDC00库肯的毛皮|r
step << Shaman
    .goto Azuremyst Isle,46.7,20.8
    .accept 9622 >>接任务: |cFFFCDC00警告你的人民|r
step
	#label end
    .goto Azuremyst Isle,44.8,23.8
    .turnin 9571 >>交任务: |cFF00FF25库肯的毛皮|r
step << Shaman
    .goto Azuremyst Isle,59.6,17.9
    .turnin 9465 >>交任务: |cFF00FF25火焰的召唤|r
    .accept 9467 >>接任务: |cFFFCDC00火焰的召唤|r
step << Shaman
	.hs >>炉灶 to Azure手表
step << Shaman
    .goto Azuremyst Isle,47.1,50.6
    .turnin 9622 >>交任务: |cFF00FF25警告你的人民|r
step << Shaman
    #sticky
	#completewith next
    >>点击包中的防火包
...
step << Shaman
    ...
    .turnin 9467 >>交任务: |cFF00FF25火焰的召唤|r
    .accept 9468 >>接任务: |cFFFCDC00火焰的召唤|r
step
	#sticky
	#label SGrain
...
step
    ...
    .accept 9564 >>接任务: |cFFFCDC00古尔弗的尊严|r
step
	#requires SGrain
...
step
    ...
    .turnin 9625 >>交任务: |cFF00FF25雷象可不是好玩的！|r
step
    .goto Bloodmyst Isle,63.1,88.0
...
step
    ...
    .accept 9603 >>接任务: |cFFFCDC00床铺，绷带，以及更多|r
step
	#completewith next
	.goto Bloodmyst Isle,55.7,59.7
    .home >>将您的炉石设置为血液观察
...
step
    .goto Bloodmyst Isle,57.6,54.0
    .turnin 9603 >>交任务: |cFF00FF25床铺，绷带，以及更多|r
    >>跳过后续任务
step
...
step
    ...
    .goto Bloodmyst Isle,59.3,89.1
	.xp 12+3300>>研磨直到3300 exp进入12级（3300+10100）
step
	#label grind3800
	.goto Bloodmyst Isle,59.3,89.1
	.xp 12+4140>>研磨，直到4140 exp进入12级（4140+/10100）
step
...
step
    ...
    .turnin 9624 >>交任务: |cFF00FF25美味的点心|r
step
    .goto Bloodmyst Isle,63.1,87.9
    .turnin 9634 >>交任务: |cFF00FF25大战异型掠夺者|r
step
...
step
    .goto Azuremyst Isle,44.7,23.5
    .turnin 9564 >>交任务: |cFF00FF25古尔弗的尊严|r
    .turnin 9562 >>交任务: |cFF00FF25鱼人......|r
step << Warrior
	#completewith kesselrun
    .goto Azuremyst Isle,50.0,50.6
    .turnin 9582 >>交任务: |cFF00FF25一人之力|r
    .accept 10350 >>接任务: |cFFFCDC00贝霍玛特|r
	.trainer >>训练你的12级法术
step << !Shaman
	.isOnQuest 9612
...
step << Shaman
    .goto Azuremyst Isle,48.05,50.41
    .turnin 9468 >>交任务: |cFF00FF25火焰的召唤|r
    .accept 9461 >>接任务: |cFFFCDC00火焰的召唤|r
step << Shaman
	#completewith next
	.isOnQuest 9612
    .goto Azuremyst Isle,47.1,50.5
...
step
    .goto Azuremyst Isle,46.9,70.3
    .turnin 9515 >>接任务: |cFFFCDC00督军斯雷提兹|r
...
step << Paladin
    ...
    .accept 9598 >>接任务: |cFFFCDC00救赎|r
    .turnin 9598 >>交任务: |cFF00FF25救赎|r
    .accept 9600 >>接任务: |cFFFCDC00救赎|r
	.trainer >>训练你的12级法术
step << !Shaman
	#completewith next
	.hs >>心脏到血液观察
...
step
    .goto Bloodmyst Isle,52.7,53.3
    .turnin 9581 >>交任务: |cFF00FF25研究水晶|r
...
step
    ...
    .turnin 9663 >>交任务: |cFF00FF25凯希尔的信使|r
    .accept 9666 >>接任务: |cFFFCDC00展示力量|r
step
    .goto Bloodmyst Isle,68.2,81.1
    .accept 9667 >>接任务: |cFFFCDC00拯救止松公主|r
step << Paladin
...
step
    ...
    .turnin 9666 >>交任务: |cFF00FF25展示力量|r
    .accept 9668 >>接任务: |cFFFCDC00向主教埃德门图斯报告|r
step
...
step
    ...
    .turnin 9629 >>交任务: |cFF00FF25研究鱼人|r
...
step
    ...
    .turnin 9667 >>交任务: |cFF00FF25拯救止松公主|r
step
    .goto Bloodmyst Isle,56.4,56.7
    .turnin 9648 >>交任务: |cFF00FF25玛特帕尔姆蘑菇展|r
step
    .goto Bloodmyst Isle,55.4,55.3
...
step
    ...
    .turnin 9668 >>交任务: |cFF00FF25向主教埃德门图斯报告|r
step
    #sticky
	#label Missive
...
step
    ...
    .accept 9672 >>接任务: |cFFFCDC00血咒的遗产|r
step
	#sticky
	#completewith next
...
step
    ...
    .turnin 9672 >>交任务: |cFF00FF25血咒的遗产|r
    .accept 9674 >>接任务: |cFFFCDC00血咒纳迦|r
step
...
step
    .goto Bloodmyst Isle,79.1,22.6
    .turnin 9674 >>交任务: |cFF00FF25血咒纳迦|r
step
    .goto Bloodmyst Isle,79.1,22.6
    .accept 9682 >>接任务: |cFFFCDC00绝望者......|r
    .maxlevel 15
step
...
step
    ...
    .turnin 9682 >>交任务: |cFF00FF25绝望者......|r
    .isOnQuest 9682
step
    .isOnQuest 9682
...
step
    .goto Bloodmyst Isle,79.2,22.7
    .accept 9683 >>接任务: |cFFFCDC00血咒的终结|r
...
step << Shaman/Paladin wotlk/Hunter
    .goto Bloodmyst Isle,79.2,22.7
    .turnin 9683 >>交任务: |cFF00FF25血咒的终结|r
    .isOnQuest 9683
    .xp 16-2190,1
step << Shaman/Paladin wotlk/Hunter
...
step
    ...
    .accept 9604 >>接任务: |cFFFCDC00乘坐角鹰兽|r
step
    .goto Bloodmyst Isle,57.6,53.9
...
step
    ...
    .turnin 9604 >>交任务: |cFF00FF25乘坐角鹰兽|r
    .accept 9605 >>接任务: |cFFFCDC00斯泰法努斯|r
step << Warrior
    .turnin 10350 >>交任务: |cFF00FF25贝霍玛特|r
...
step << Shaman
    ...
    .turnin 9461 >>交任务: |cFF00FF25火焰的召唤|r
    .accept 9555 >>接任务: |cFFFCDC00火焰的召唤|r
    .turnin -9698 >>交任务: |cFF00FF25会见先知|r
    .accept 9699 >>接任务: |cFFFCDC00真相还是谎言|r
step << Paladin
    .goto The Exodar,38.8,82.6
    .turnin 9600 >>交任务: |cFF00FF25救赎|r
step << !Shaman
...
step << Shaman
    ...
    .turnin 9555 >>交任务: |cFF00FF25火焰的召唤|r
	.trainer >>训练你的16级法术
step
	.goto The Exodar,52.3,34.7,80,0
    .goto The Exodar,68.4,63.5
    >>跑回飞行管理员
    .turnin 9605 >>交任务: |cFF00FF25斯泰法努斯|r
    .accept 9606 >>接任务: |cFFFCDC00返回托菲尔·罗阿身边|r
step
	#completewith next
    .goto The Exodar,68.4,63.5
...
step
    ...
    .turnin 9606 >>交任务: |cFF00FF25返回托菲尔·罗阿身边|r
step
    #label exit1
    .goto Bloodmyst Isle,55.5,55.4
    .turnin -9699 >>交任务: |cFF00FF25真相还是谎言|r
...
step
	#completewith next
    .goto Bloodmyst Isle,55.4,55.2
    .turnin 9700 >>交任务: |cFF00FF25黑暗中的魔法|r
...
step
    .goto Bloodmyst Isle,55.0,58.1
    .turnin 9569 >>交任务: |cFF00FF25化解危机|r
step
...
step
    ...
    .turnin 9703 >>交任务: |cFF00FF25冷却核心|r
    .turnin 9706 >>交任务: |cFF00FF25加莱恩的日记 - 守备官撒鲁安的命运|r
    .accept 9711 >>接任务: |cFFFCDC00残忍的玛提斯|r
    .accept 9748 >>接任务: |cFFFCDC00毒水|r
    .accept 9753 >>接任务: |cFFFCDC00我们所知道的......|r
step
    .goto Bloodmyst Isle,52.6,53.3
    .turnin 9753 >>交任务: |cFF00FF25我们所知道的......|r
    .accept 9756 >>接任务: |cFFFCDC00我们不知道的......|r
step
    >>打开笼子和囚犯说话
    .skipgossip
    .complete 9756,1
    .goto Bloodmyst Isle,54.36,54.30
    .turnin 9756 >>交任务: |cFF00FF25我们不知道的......|r
    .goto Bloodmyst Isle,52.6,53.3
    .accept 9760 >>接任务: |cFFFCDC00守备官营地|r
step
	#completewith AliveM
...
step
    ...
    .accept 10067 >>接任务: |cFFFCDC00污秽的水之魂|r
     .turnin 9760 >>交任务: |cFF00FF25守备官营地|r
step
    #sticky
	#completewith next
...
step << Hunter/Shaman/Mage
    ...
    .isOnQuest 9746
    .goto Bloodmyst Isle,55.6,55.3
    .turnin 9746 >>交任务: |cFF00FF25精疲力尽|r
    .accept 9740 >>接任务: |cFFFCDC00太阳之门|r
step << Hunter/Shaman/Mage
    #label sungate
    #completewith L20
    #requires limit2
...
step
    ...
    .turnin 9748 >>交任务: |cFF00FF25毒水|r
    .turnin 9711 >>交任务: |cFF00FF25残忍的玛提斯|r
    .accept 9746 >>接任务: |cFFFCDC00精疲力尽|r
...
step
	#requires sungate
	.goto Bloodmyst Isle,55.6,55.3
	.turnin 9740 >>交任务: |cFF00FF25太阳之门|r
step
	#label bearend
    .goto Bloodmyst Isle,55.9,56.9
    .turnin 9647 >>交任务: |cFF00FF25消灭巨蛾|r
    .turnin 9580 >>交任务: |cFF00FF25猎熊|r
step
...
step << Shaman
    ...
    .accept 9502 >>接任务: |cFFFCDC00水之召唤|r
step << Shaman
    .goto The Exodar,31.3,30.7
    .turnin 9502 >>交任务: |cFF00FF25水之召唤|r
    .accept 9501 >>接任务: |cFFFCDC00水之召唤|r
	.trainer >>训练你的20级技能
step << Shaman
    .goto The Exodar,68.4,63.5
...
step << Shaman
    ...
    .turnin 9501 >>交任务: |cFF00FF25水之召唤|r
    .accept 9503 >>接任务: |cFFFCDC00水之召唤|r
step << Shaman
    .goto Bloodmyst Isle,24.8,51.3
    .complete 9746,1 --Kill Sunhawk Pyromancer (x10)
    .complete 9746,2 --Kill Sunhawk Defender (x10)
...
step << Shaman
    ...
    .turnin 9503 >>交任务: |cFF00FF25水之召唤|r
    .accept 9504 >>接任务: |cFFFCDC00水之召唤|r
step << Shaman
...
step
	...
	.turnin -9633 >>交任务: |cFF00FF25前往奥伯丁|r
