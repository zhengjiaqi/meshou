...
step << Warrior
.accept 64028 >>接任务: |cFFFCDC00新的开始|r
    .turnin 64028 >>交任务: |cFF00FF25新的开始|r
    .accept 64031 >>接任务: |cFFFCDC00生存工具|r
...
step << Warrior
    ...
    .accept 64038 >>接任务: |cFFFCDC00黑暗之门|r
--
step << Paladin
...
step << skip
    ...
    .accept 6182 >>接任务: |cFFFCDC00第一个和最后一个|r
...
step
    ...
    .accept 4182 >>接任务: |cFFFCDC00黑龙的威胁|r
step
...
step
    ...
    .turnin 4182 >>交任务: |cFF00FF25黑龙的威胁|r
    .accept 4183 >>接任务: |cFFFCDC00真正的主人|r
step
    .goto Burning Steppes,84.4,68.4
    .fly Lakeshire >>飞往莱克郡
step
    .goto Redridge Mountains,29.8,44.5
    .turnin 4183 >>交任务: |cFF00FF25真正的主人|r
    .accept 4184 >>接任务: |cFFFCDC00真正的主人|r
step
    .goto Redridge Mountains,30.58,59.41
    .fly Stormwind>>飞到暴风城
step
    .goto StormwindClassic,78.0,18.2
    .turnin 4184 >>交任务: |cFF00FF25真正的主人|r
    .accept 4185 >>接任务: |cFFFCDC00真正的主人|r
-- .accept 6182 >>接任务: |cFFFCDC00第一个和最后一个|r
step
...
step
    .goto StormwindClassic,78.0,18.2
    .turnin 4185 >>交任务: |cFF00FF25真正的主人|r
    .accept 4186 >>接任务: |cFFFCDC00真正的主人|r
step << skip
    .goto StormwindClassic,75.9,59.8
    .turnin 6182 >>交任务: |cFF00FF25第一个和最后一个|r
    .accept 6183 >>接任务: |cFFFCDC00逝者的荣耀|r
    .turnin 6183 >>交任务: |cFF00FF25逝者的荣耀|r
    .accept 6184 >>接任务: |cFFFCDC00弗林特·沙多摩尔|r
step
    .goto StormwindClassic,66.2,62.3
    .fly Lakeshire >>飞往莱克郡
step
    .goto Redridge Mountains,29.8,44.5
    .turnin 4186 >>交任务: |cFF00FF25真正的主人|r
    .accept 4223 >>接任务: |cFFFCDC00真正的主人|r
step
    .goto Redridge Mountains,30.6,59.4
    .fly Morgan's Vigil >>飞往摩根守夜
step
    .goto Burning Steppes,84.6,68.9
    .turnin 4223 >>交任务: |cFF00FF25真正的主人|r
step
...
step
    ...
    >>与《奇风》中的德莱尼NPC对话
    .accept 9474 >>接任务: |cFFFCDC00光明使者的印记|r
    >>任务给予者是长脚本RP序列的一部分，如果你找不到他，请跳过这一步
step
    .goto Western Plaguelands,42.8,84.0
    .accept 5092 >>接任务: |cFFFCDC00扫清道路|r
step
    .goto Western Plaguelands,43.4,84.8
    .accept 5903 >>接任务: |cFFFCDC00瘟疫与你|r
step << skip
    .goto Western Plaguelands,43.7,84.5
    .turnin 6184 >>交任务: |cFF00FF25弗林特·沙多摩尔|r
    .accept 6185 >>接任务: |cFFFCDC00东部的瘟疫|r
step
    #label mark1
...
step
    ...
    .accept 5282 >>接任务: |cFFFCDC00永不安息的灵魂|r
step
    #completewith next
    .hs >>炉灶到Southshore
step
...
step
    ...
    >>与房子里的玛琳·雷德帕斯交谈
    .accept 5142 >>接任务: |cFFFCDC00小帕米拉|r
step
    .goto Western Plaguelands,42.8,84.0
    .turnin 5092 >>交任务: |cFF00FF25扫清道路|r
    .accept 5097 >>接任务: |cFFFCDC00标记哨塔|r
    .accept 5215 >>接任务: |cFFFCDC00瘟疫之锅|r
step
    .goto Western Plaguelands,43.0,84.6
    .turnin 5215 >>交任务: |cFF00FF25瘟疫之锅|r
    .accept 5216 >>接任务: |cFFFCDC00目标：费尔斯通农场|r
step
    .goto Western Plaguelands,43.4,84.8
    .turnin 5903 >>交任务: |cFF00FF25瘟疫与你|r
    .accept 5904 >>接任务: |cFFFCDC00瘟疫与你|r
step
...
step
    ...
    >>杀死釜主，抢夺釜钥匙
    .turnin 5216 >>交任务: |cFF00FF25目标：费尔斯通农场|r
    .accept 5217 >>接任务: |cFFFCDC00返回冰风岗|r
step
...
step
    ...
    .turnin 5217 >>交任务: |cFF00FF25返回冰风岗|r
    .accept 5219 >>接任务: |cFFFCDC00目标：达尔松之泪|r
step
...
step
    ...
    .turnin 5219 >>交任务: |cFF00FF25目标：达尔松之泪|r
    .accept 5220 >>接任务: |cFFFCDC00返回冰风岗|r
step
...
step
    ...
    .turnin 5904 >>交任务: |cFF00FF25瘟疫与你|r
    .accept 6389 >>接任务: |cFFFCDC00瘟疫与你|r
step
...
step
    ...
    .turnin 5097 >>交任务: |cFF00FF25标记哨塔|r
    .accept 5533 >>接任务: |cFFFCDC00通灵学院|r
step
    .goto Western Plaguelands,42.69,83.90
    .turnin 5533 >>交任务: |cFF00FF25通灵学院|r
    .accept 5537 >>接任务: |cFFFCDC00骸骨碎片|r
step
    .goto Western Plaguelands,42.94,84.42
    .turnin 5220 >>交任务: |cFF00FF25返回冰风岗|r
    .accept 5222 >>接任务: |cFFFCDC00目标：嚎哭鬼屋|r
step
    .goto Western Plaguelands,42.94,84.42
    .turnin 9474 >>交任务: |cFF00FF25光明使者的印记|r
    .isQuestComplete 9474
step
    .goto Western Plaguelands,43.5,84.9
    .turnin 6389 >>交任务: |cFF00FF25瘟疫与你|r
step
...
step
    ...
    .turnin 5222 >>交任务: |cFF00FF25目标：嚎哭鬼屋|r
    .accept 5223 >>接任务: |cFFFCDC00返回冰风岗|r
step
    .goto Western Plaguelands,53.7,64.7
...
step
    ...
    .accept 4986 >>接任务: |cFFFCDC00雕文橡木枝|r
step
    .goto Western Plaguelands,42.9,84.5
    .turnin 5223 >>交任务: |cFF00FF25返回冰风岗|r
    .accept 5225 >>接任务: |cFFFCDC00目标：盖罗恩农场|r
step
    .goto Western Plaguelands,62.6,58.7
    .turnin 5225 >>交任务: |cFF00FF25目标：盖罗恩农场|r
    .accept 5226 >>接任务: |cFFFCDC00返回冰风岗|r
step
	>>去地下室的底部
...
step
    ...
    .turnin 5142 >>交任务: |cFF00FF25小帕米拉|r
...
step
    .goto Western Plaguelands,42.9,84.5
    .turnin 5226 >>交任务: |cFF00FF25返回冰风岗|r
step
    .goto Western Plaguelands,42.7,84.1
    .turnin 5237 >>交任务: |cFF00FF25任务完成！|r
step
    .goto Western Plaguelands,42.7,83.8
    .turnin 5537 >>交任务: |cFF00FF25骸骨碎片|r
step << skip
    .goto Western Plaguelands,43.6,84.4
    .turnin 6185 >>交任务: |cFF00FF25东部的瘟疫|r
    .accept 6186 >>接任务: |cFFFCDC00凋零者|r
step
...
step
    ...
    .accept 5181 >>接任务: |cFFFCDC00达隆郡的恶魔|r
step
...
step
    ...
    .turnin 5181 >>交任务: |cFF00FF25达隆郡的恶魔|r
...
step << skip
    ...
    .turnin 6186 >>交任务: |cFF00FF25凋零者|r
]])
